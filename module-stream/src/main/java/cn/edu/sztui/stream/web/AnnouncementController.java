 ...
 * 公告接口控制器
 * 
 * 文件位置：module-stream/src/main/java/cn/edu/sztui/stream/web/AnnouncementController.java
 */
@Slf4j
@RestController
@RequestMapping("/annc")
...
public class AnnouncementController {
    ...
    public Result getDetail(
        ...
        log.info("用户{} 获取公告详情: id={}", openId, id);
    ...
    public Result fullTextSearch(
        ...
        String openId = UserContext.getContext().getOpenId();
        log.info("用户{} 进行全文搜索: keyword={}", openId, keyword);
    ...
    public Result getCategories() {
        ...
        return Result.ok(configLoader.getCategoryCodeMap());
    }
