...
public interface SchoolAPIs
{
    ...
    final String gatewaySmsReqURL ="https://auth-sztu-edu-cn-s.webvpn.sztu.edu.cn:8118/idp/sendSMSCheckCode.do";
    ...
    // 网关登录页面
    final String internalNetStartURL = "https://home-sztu-edu-cn-s.webvpn.sztu.edu.cn:8118/bmportal/index.portal";
    ...
    final String AcdmStartURL = "https://jwxt-sztu-edu-cn-s.webvpn.sztu.edu.cn:8118/jsxsd/framework/xsMain";;
