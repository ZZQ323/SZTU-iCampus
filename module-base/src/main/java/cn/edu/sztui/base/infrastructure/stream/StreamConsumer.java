...
public class StreamConsumer {
    ...
    private void processMessage(String topic, MapRecord<String, String, String> record) {
        ...
        try {
            ...
            // 构建 SSE 消息
            SseMessage<JsonNode> sseMessage = new SseMessage<>();
            sseMessage.setType(type);
            sseMessage.setTargetUser(targetUser);
            sseMessage.setMessage(extraMessage);
            sseMessage.setTimestamp(timestampStr != null ? Long.parseLong(timestampStr) : System.currentTimeMillis());
